import{_ as n,c as a,a as e,o as i}from"./app-BsCzzVAk.js";const l={};function r(p,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="wget" tabindex="-1"><a class="header-anchor" href="#wget"><span>wget</span></a></h1><p><a href="https://baijiahao.baidu.com/s?id=1714300855200071381&amp;wfr=spider&amp;for=pc" target="_blank" rel="noopener noreferrer">wget</a></p><p>wget 是一个从网络上自动下载文件的自由工具，支持通过 HTTP、HTTPS、FTP 三个最常见的 TCP/IP协议 下载，并可以使用 HTTP 代理。&quot;wget&quot; 这个名称来源于 “World Wide Web” 与 “get” 的结合。 所谓自动下载，是指 wget 可以在用户退出系统的之后在继续后台执行，直到下载任务完成。</p><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><div class="language- line-numbers-mode" data-ext="" data-title=""><button class="copy" title="复制代码" data-copied="已复制"></button><pre class="shiki shiki-themes vitesse-light vitesse-dark vp-code"><code><span class="line"><span>$ brew install wget</span></span>
<span class="line"><span>brew install wget </span></span>
